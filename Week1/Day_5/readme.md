...
```
![in_comp_if](incomp_if_simulation.jpg)

---

### Lab 2: Synthesis Result of Lab 1

![incomp_synth](incomp_if_synthesis.jpg)
...
```
![icomp2](incomp_if2_simulation.jpg)

---

### Lab 4: Synthesis Result of Lab 3

![incomp2synth](incomp_if2_synthesis.jpg)
...
```
![compcase](comp_case_simulation.jpg)
...
![compcase](comp_case_synthesis.jpg)
...
```
![badcase](bad_case_simulation.jpg)
...
```
![Partial Case Assignment](partial_case_simulation.jpg)

> **Note:** Steps to perform the above labs are shown in [Day 1](https://github.com/AnshChaudhary01/AnshChaudhary_RISC-V-SoC-Tapeout-Program_VSD/tree/main/Week1/Day_1).
...
```
![mux_generate](mux_generate_simulation.jpg)
...
```
![demux-case](demux_case_simulation.jpg)
...
```
![rca_org](rca_simulation.jpg)

---

> **Note:** Steps to perform the above labs are already shown in [Day 1](https://github.com/AnshChaudhary01/AnshChaudhary_RISC-V-SoC-Tapeout-Program_VSD/tree/main/Week1/Day_1).
